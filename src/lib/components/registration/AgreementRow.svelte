...
<style>
	...
	.check-row { display: flex; flex-wrap: wrap; align-items: center; gap: 0.9rem; }
	...
	.read { color: var(--ink-70); text-decoration: underline; text-underline-offset: 3px; font-size: var(--text-author); }
	.read:hover { color: var(--ink); }
	.ver { color: var(--ink-45); font-size: 0.75rem; letter-spacing: 0.1em; text-transform: uppercase; }
