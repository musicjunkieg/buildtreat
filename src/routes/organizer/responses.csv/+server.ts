...
import { responsesCsv } from '$lib/server/organizer/csv';
...
export const GET: RequestHandler = async ({ locals, platform }) => {
	...
	const body = responsesCsv(await getAllResponses(db));
	return new Response(body, {
		headers: {
			'content-type': 'text/csv; charset=utf-8',
			'content-disposition': 'attachment; filename="retreat-responses.csv"',
